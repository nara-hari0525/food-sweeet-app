...
// Master data compilation of 500 authentic Indian recipes across all regions and states
const recipes = [];

// Helper image mapping for high-quality culinary presentation
...
function getSampleImageUrl(category, subcategory, name) {
  ...
  if (n.includes('fish') || n.includes('mach') || n.includes('meen') || n.includes('trout') || n.includes('pomfret') || n.includes('ilish')) return CATEGORY_IMAGES.fish;
  if (n.includes('prawn') || n.includes('crab') || n.includes('squid') || n.includes('shrimp') || n.includes('chingri')) return CATEGORY_IMAGES.seafood;
  if (n.includes('mutton') || n.includes('gosht') || n.includes('lamb') || n.includes('pork') || n.includes('beef') || n.includes('sukka') || n.includes('laal maas') || n.includes('rogan josh') || n.includes('kosha mangsho')) return CATEGORY_IMAGES.mutton;
  if (n.includes('chicken') || n.includes('kodi') || n.includes('murgh') || n.includes('tikka') || n.includes('tandoori')) return CATEGORY_IMAGES.chicken;
  if (n.includes('dal') || n.includes('pappu') || n.includes('sambar') || n.includes('rasam') || n.includes('kadhi') || n.includes('dalma') || n.includes('chainsoo')) return CATEGORY_IMAGES.dal;
  ...
  if (c.includes('sweets') || c.includes('desserts') || n.includes('halwa') || n.includes('kheer') || n.includes('laddu') || n.includes('jamun') || n.includes('payasam') || n.includes('sandesh') || n.includes('rosogolla') || n.includes('modak') || n.includes('peda')) return CATEGORY_IMAGES.sweets;
  if (c.includes('drinks') || n.includes('lassi') || n.includes('chai') || n.includes('sherbet') || n.includes('solkadhi') || n.includes('kahwa')) return CATEGORY_IMAGES.drinks;
  if (c.includes('street') || n.includes('chaat') || n.includes('puri') || n.includes('pav') || n.includes('pakora') || n.includes('samosa') || n.includes('kachori') || n.includes('dhokla')) return CATEGORY_IMAGES.street;
...
// Master raw recipe definitions generator for 500 distinct items
