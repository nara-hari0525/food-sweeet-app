...
console.log("Starting full 500+ Indian Recipes JSON Generator...");
...
// Master state-by-state recipe database
export const ALL_RAW_DATA = [];

console.log("Loading regional datasets...");
